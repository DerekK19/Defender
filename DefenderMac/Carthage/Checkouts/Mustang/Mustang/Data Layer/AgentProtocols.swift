...
internal protocol AmpServiceAgentProtocol {
    ...
    func savePresetForDeviceWithVendorId(_ vendorId: Int, productId: Int, locationId: UInt32, preset: UInt8, name: String, onSuccess: @escaping (_ saved: Bool) -> (), onFail: @escaping () -> ())
    func confirmChangeForDeviceWithVendorId(_ vendorId: Int, productId: Int, locationId: UInt32, onSuccess: @escaping (_ saved: Bool) -> (), onFail: @escaping () -> ())
}
...
internal protocol FileServiceAgentProtocol {
    ...
    func importPresetWithXml(_ xml: XMLDocument, onSuccess: @escaping (_ preset: DLPreset) -> (), onFail: @escaping () -> ())
}
